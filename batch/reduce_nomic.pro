...
;   
; PURPOSE
;   Main batch routine to reduce LBTI NOMIC direct imaging data (see LBTI_DRS.pro for more information)
;
; MANDATORY INPUT
...
PRO REDUCE_NOMIC, date, BAD_IDX=bad_idx, BCKG_IDX=bckg_idx,  DARK_IDX=dark_idx, DATA_IDX=data_idx, FLAT_IDX=flat_idx, NOD_IDX=nod_idx, $     ; Date to reduce and file index 
