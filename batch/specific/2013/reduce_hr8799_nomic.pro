PRO REDUCE_HR8799_NOMIC, REDUCE=reduce
...
IF KEYWORD_SET(reduce) THEN BEGIN
  ...
  IF date EQ '131017' THEN BEGIN
   ...
   ENDIF  
   ; Pre-crop the frames
   IF date EQ '131021' THEN BEGIN
     ;LBTI_FITSUTIL, date, [0,434], CROP=[64,256,512,768], LMIRCAM=lmircam
