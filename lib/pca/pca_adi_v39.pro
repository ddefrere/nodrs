...
;   
; CALLING SEQUENCE:
;   Result = PCA_ADI_V38(cx_init, cy_init, dim, dim_init, fwhm, truncate_pca, Na, rin_init, right_handed, $ 
...
;   Version 3.8, 30-JUL-2013, OA: some more cleaning
; 	Version 3.9, 22-SEP-2013, DM: add ADI for truncate_pca=0


FUNCTION PCA_ADI_V39, cx_init, cy_init, dim, dim_init, fwhm, truncate_pca, Na, rin_init, right_handed, $ 
                      NORMAL=normal, DISPLAY=display, VERBOSE=verbose, WCS=wcs
...
if truncate_pca eq 0 then begin

median_obj=median(obj,dim=3)

for i=0,nobj-1 do begin 
 	objt[*,*,i]=obj[*,*,i]-median_obj
endfor
