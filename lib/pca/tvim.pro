...
;                noaxis=noaxis,noxlabel=noxlabel,noylabel=noylabel,interp=interp,colors=colors,c_map=c_map,     $
...
; 20aug14: added NOXLABEL and NOYLABEL keywords
;-

pro tvim,a,scale=scale,range=range,xrange=xrange,yrange=yrange,$
        aspect=aspect,title=title,xtitle=xtitle,ytitle=ytitle,$
        noframe=noframe,noaxis=noaxis,noxlabel=noxlabel,noylabel=noylabel,noxylabel=noxylabel,interp=interp,colors=colors,c_map=c_map,$
...
case 1 of 
  ...
  keyword_set(noxlabel): plot,[0,0],[0,0],/xstyle,/ystyle,position=pos,$
                            title=title,xtitle=xtitle,ytitle=ytitle,/device, $
                            xrange=xrng,yrange=yrng,/noerase,/nodata,$
                            charsize=pcharsize, xtickname=[" "," "," "," "," "]
  
  keyword_set(noylabel): plot,[0,0],[0,0],/xstyle,/ystyle,position=pos,$
                            title=title,xtitle=xtitle,ytitle=ytitle,/device, $
                            xrange=xrng,yrange=yrng,/noerase,/nodata,$
                            charsize=pcharsize, ytickname=[" "," "," "," "," "]
                            
  keyword_set(noxylabel): plot,[0,0],[0,0],/xstyle,/ystyle,position=pos,$
                            title=title,xtitle=xtitle,ytitle=ytitle,/device, $
                            xrange=xrng,yrange=yrng,/noerase,/nodata,$
                            charsize=pcharsize, ytickname=[" "," "," "," "," "], $
                            xtickname=[" "," "," "," "," "]
