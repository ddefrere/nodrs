...
PRO mfilter_v4b, highpass=highpass, lowpass=lowpass, bandpass_low=bandpass_low, bandpass_high=bandpass_high, median_f=median_f,$ 
mean_f=mean_f, gauss_f=gauss_f, fourier_ideal=fourier_ideal, fourier_gauss=fourier_gauss, fourier_butterworth=fourier_butterworth, display=display
