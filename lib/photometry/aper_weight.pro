...
;
  ...
  ;apmag[g] = apmag[g] - skymod*area[g]  ;Subtract sky from the integrated brightnesses #Feb 2017, now remove background above for better precision
...
PRO TEST_APERWEIGHT
  ...
  FOR i_img = 0, n_img-1 DO BEGIN
    ...
    flx0[i_img] = flx_tot0 & bck0[i_img] = bck_flx0-real_bck
    flx1[i_img] = flx_tot1 & bck1[i_img] = bck_flx1-real_bck
    flx2[i_img] = flx_tot2 & bck2[i_img] = bck_flx2-real_bck
    flx3[i_img] = flx_tot3 & bck3[i_img] = bck_flx3-real_bck
    flx4[i_img] = flx_tot4 & bck4[i_img] = bck_flx4-real_bck
    flx5[i_img] = flx_tot5 & bck5[i_img] = bck_flx5-real_bck
  ENDFOR
  PLOT, INDGEN(n_img), flx5
  OPLOT, INDGEN(n_img), flx0, LINESTYLE=1
  AVGSDV, flx0, avg0, rms0 & AVGSDV, bck0, avg_b0, rms_b0
  AVGSDV, flx1, avg1, rms1 & AVGSDV, bck1, avg_b1, rms_b1
  AVGSDV, flx2, avg2, rms2 & AVGSDV, bck2, avg_b2, rms_b2
  AVGSDV, flx3, avg3, rms3 & AVGSDV, bck3, avg_b3, rms_b3
  AVGSDV, flx4, avg4, rms4 & AVGSDV, bck4, avg_b4, rms_b4
  AVGSDV, flx5, avg5, rms5 & AVGSDV, bck5, avg_b5, rms_b5
