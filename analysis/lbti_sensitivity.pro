...
;  PRINT, '====================================================================== '
  ...
  ; Alf Cep
  PRINT, '====================================================================== '
  files = path + ['2016-10-16_APR/UT2016-10-16_ID026_SCI_alf_Cep_DIT-53ms_11um_PHOT1.fits', '2016-10-16_APR/UT2016-10-16_ID026_SCI_alf_Cep_DIT-53ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=7.04, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=7.04, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  ...
  ; 107 Psc
  PRINT, '====================================================================== '
  files = path + ['2016-11-14_APR/UT2016-11-14_ID044_SCI_107_Psc_DIT-68ms_11um_PHOT1.fits', '2016-11-14_APR/UT2016-11-14_ID044_SCI_107_Psc_DIT-68ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=2.02, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=2.02, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; ksi Peg A
  PRINT, '====================================================================== '
  files = path + ['2016-11-16_APR/UT2016-11-16_ID013_SCI_ksi_Peg_A_DIT-60ms_11um_PHOT1.fits', '2016-11-16_APR/UT2016-11-16_ID013_SCI_ksi_Peg_A_DIT-60ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=2.22, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=2.22, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; 23 UMa
  PRINT, '====================================================================== '
  files = path + ['2017-02-11_APR/UT2017-02-11_ID015_SCI_23_UMa_DIT-45ms_11um_PHOT1.fits', '2017-02-11_APR/UT2017-02-11_ID015_SCI_23_UMa_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=2.55, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=2.55, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; 1 Ori
  PRINT, '====================================================================== '
  files = path + ['2017-02-09_APR/UT2017-02-09_ID013_SCI_1_Ori_DIT-45ms_11um_PHOT1.fits', '2017-02-09_APR/UT2017-02-09_ID013_SCI_1_Ori_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=4.76, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=4.76, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; bet UMa
  PRINT, '====================================================================== '
  files = path + ['2017-04-03_APR/UT2017-04-03_ID027_SCI_bet_UMa_DIT-45ms_11um_PHOT1.fits', '2017-04-03_APR/UT2017-04-03_ID027_SCI_bet_UMa_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=4.2, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=4.2, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; chi Her
  PRINT, '====================================================================== '
  files = path + ['2017-04-11_APR/UT2017-04-11_ID036_SCI_chi_Her_DIT-45ms_11um_PHOT1.fits', '2017-04-11_APR/UT2017-04-11_ID036_SCI_chi_Her_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=2.03, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=2.03, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; del Leo
  PRINT, '====================================================================== '
  files = path + ['2017-05-12_APR/UT2017-05-12_ID016_SCI_del_Leo_DIT-45ms_11um_PHOT1.fits', '2017-05-12_APR/UT2017-05-12_ID016_SCI_del_Leo_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=3.9, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=3.9, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; lam Ser
  PRINT, '====================================================================== '
  files = path + ['2017-05-01_APR/UT2017-05-01_ID035_SCI_lam_Ser_DIT-45ms_11um_PHOT1.fits', '2017-05-01_APR/UT2017-05-01_ID035_SCI_lam_Ser_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=2.4, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=2.4, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; eps Eri
  PRINT, '====================================================================== '
  files = path + ['2017-12-20_APR/UT2017-12-20_ID034_SCI_eps_Eri_DIT-45ms_11um_PHOT1.fits', '2017-12-20_APR/UT2017-12-20_ID034_SCI_eps_Eri_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=7.39, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=7.39, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  ...
  ; 1 Ori
  PRINT, '====================================================================== '
  files = path + ['2017-12-20_APR/UT2017-12-20_ID068_SCI_1_Ori_DIT-45ms_11um_PHOT1.fits', '2017-12-20_APR/UT2017-12-20_ID068_SCI_1_Ori_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=4.76, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=4.76, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  ...
  ; tau Cet
  PRINT, '====================================================================== '
  files = path + ['2018-01-05_APR/UT2018-01-05_ID018_SCI_tau_Cet_DIT-45ms_11um_PHOT1.fits', '2018-01-05_APR/UT2018-01-05_ID018_SCI_tau_Cet_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=5.42, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=5.42, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; 13 UMa
  PRINT, '====================================================================== '
  files = path + ['2018-03-29_APR/UT2018-03-29_ID018_SCI_13_Uma_DIT-45ms_11um_PHOT1.fits', '2018-03-29_APR/UT2018-03-29_ID018_SCI_13_Uma_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=1.24, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=1.24, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; bet Vir
  PRINT, '====================================================================== '
  files = path + ['2018-03-30_APR/UT2018-03-30_ID049_SCI_bet_Vir_DIT-45ms_11um_PHOT1.fits', '2018-03-30_APR/UT2018-03-30_ID049_SCI_bet_Vir_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=4.3, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=4.3, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; 72 Her
  PRINT, '====================================================================== '
  files = path + ['2018-05-23_APR/UT2018-05-23_ID039_SCI_72_Her_DIT-45ms_11um_PHOT1.fits', '2018-05-23_APR/UT2018-05-23_ID039_SCI_72_Her_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=1.01, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=1.01, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
  ...
  ; del UMa
  PRINT, '====================================================================== '
  files = path + ['2018-05-25_APR/UT2018-05-25_ID035_SCI_del_UMa_DIT-45ms_11um_PHOT1.fits', '2018-05-25_APR/UT2018-05-25_ID035_SCI_del_UMa_DIT-45ms_11um_PHOT2.fits']
  data_p1 = LBTI_SENSITIVITY(FILES=files[0], FLUX=2.0, INFO=info)
  data_p2 = LBTI_SENSITIVITY(FILES=files[1], FLUX=2.0, INFO=info)
  PRINT, 'Mean optical throughput [%]   : ', STRING(100*(data_p1[0]+data_p2[0])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean overall throughput [%]   : ', STRING(100*(data_p1[1]+data_p2[1])*0.5, FORMAT='(F6.3)')
  PRINT, 'Mean sensitivity [mJy/10min]  : ', STRING((data_p1[2]+data_p2[2])*0.5, FORMAT='(F8.4)')
  PRINT, '====================================================================== '
